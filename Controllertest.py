    ...
    while t == 0:
        try:
            ...
            if joy1.get_axis(1) < -0.5:
                FL_TIBIA.move(1,10,True,False)
                FR_TIBIA.move(1,10,True,False)
                BR_TIBIA.move(1,10,True,False)
                BL_TIBIA.move(1,10,True,False)
                time.sleep(0.5)
            if joy1.get_axis(1) > 0.5:
                ...
                FL_TIBIA.move((FL_TIBIA_ANGLE - 1),10,False,False)
                FR_TIBIA.move((FR_TIBIA_ANGLE - 1),10,False,False)
                BR_TIBIA.move((BR_TIBIA_ANGLE - 1),10,False,False)
                BL_TIBIA.move((BL_TIBIA_ANGLE - 1),10,False,False)
                time.sleep(0.5)

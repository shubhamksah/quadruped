...
servo1.move(124.92,1000,False,False)
servo2.move(169.92,1000,False,False)
servo3.move(121.92,1000,False,False)
servo4.move(122.24,1000,False,False)
...
try:
    ...
    servo2angle += increment40
    servo5angle -= increment40
    servo8angle -= increment40
    servo11angle += increment40

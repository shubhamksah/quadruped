...
while stop == 0:
    try:
        ...
        if height > 0.5:
            ...
            servo1.move(servo1angle)
            servo2.move(servo2angle)
            servo3.move(servo3angle)
            servo4.move(servo4angle)
            servo5.move(servo5angle)
            servo6.move(servo6angle)
            servo7.move(servo7angle)
            servo8.move(servo8angle)
